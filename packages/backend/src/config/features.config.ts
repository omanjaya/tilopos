...
export const FEATURE_REGISTRY: FeatureDefinition[] = [
    ...
    },
    {
        ...
        category: 'inventory',
        defaultFor: ['retail_grocery', 'retail_fashion', 'retail_hardware', 'retail_electronics', 'wholesale'],
    ...
    },
    {
        ...
        category: 'marketing',
        defaultFor: ['fnb_restaurant', 'fnb_cafe', 'fnb_fastfood', 'retail_grocery', 'retail_fashion', 'retail_hardware'],
